...
def test_imports():
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location("execution_logger", "execution_logger.py")
    ...
    for extractor_file in extractors:
        try:
            ...
            print(f"❌ {extractor_file}: Erro sintaxe linha {e.lineno}: {e.msg}")
            return False
        except Exception as e:
    ...
    try:
        ...
        print(f"❌ etl_orchestrator.py: Erro sintaxe linha {e.lineno}: {e.msg}")
        return False
    except Exception as e:
