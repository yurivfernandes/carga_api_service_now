...
class BaseServiceNowExtractor:
    ...
    def paginated_request(self, endpoint: str, base_params: Dict[str, Any], limit: int = 10000) -> List[Dict]:
        """Faz requisições paginadas para buscar todos os dados"""
        all_data = []
        offset = 0
        
        while True:
            params = {**base_params, "sysparm_limit": limit, "sysparm_offset": offset}
    ...
    def print_api_metrics(self, extractor_name: str = ""):
        ...
        avg_time = metrics['total_api_time'] / max(metrics['total_requests'], 1)
    ...
    def extract_data(self, *args, **kwargs) -> pl.DataFrame:
        ...
        raise NotImplementedError("Subclasses devem implementar o método extract_data")