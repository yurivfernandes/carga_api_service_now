...
class IncidentExtractor(BaseServiceNowExtractor):
    ...
    def _get_incident_fields(self) -> str:
        ...
        fields = [
            ...
            # Status e Estado
            "state", "incident_state", "active", "resolved_at", "closed_at",
            ...
            "company", "assignment_group", "assigned_to", "caller_id",
            
            # Resolução - apenas IDs (não enriquecer)
            "resolved_by", "opened_by", "closed_by",
            
            # Descrição
            "short_description", "description", "close_notes", "resolution_notes",
            ...
            # SLA
            "business_stc", "calendar_stc", "resolve_time",
            
            # Reopen
            "reopen_count", "reopened_time",
            
            # Relacionamento
            "parent_incident", "problem_id", "change_request",
    ...
    def enrich_incident_data(self, incidents: list) -> list:
        ...
        print("ℹ️  Use as views 'incident_enriched' ou 'incident_with_names' no banco")
