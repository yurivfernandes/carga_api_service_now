...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        if command == "config":
            ...
            print("Uso:")
            print(
                "  python main.py config          - Extrai apenas dados de configuração"
            )
            print(
                "  python main.py daily           - Extrai dados dos últimos 3 dias"
            )
            print(
                "  python main.py backlog         - Extrai dados incluindo backlog"
            )
            print(
                "  python main.py custom YYYY-MM-DD YYYY-MM-DD - Extrai dados do período específico"
            )
            print(
                "  python main.py analyze         - Análise de uso de espaço"
            )
            print("  ")
            print("Opções adicionais:")
            print(
                "  --json, -j                     - Habilita armazenamento JSON comprimido"
            )
    else:
